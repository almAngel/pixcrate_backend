...
function DELETE({ path, produces = ContentType_1.ContentType.TEXT_PLAIN, consumes = ContentType_1.ContentType.TEXT_PLAIN, sealed = false }) {
    let originalMethod;
    let result;
    let response;
    let bridge;
    ...
    return function (target, propertyKey, descriptor) {
        ...
        descriptor.value = function (...args) {
            ...
            if (consumes == ContentType_1.ContentType.APP_JSON || consumes == undefined) {
                result = bootstrapper_1.App.serverManager.getInstance().delete(finalPath, [bodyParser.json(), bodyParser.urlencoded({ extended: true })], (req, res, next) => __awaiter(this, void 0, void 0, function* () {
                    yield doDummy(req, res, next);
                    originalMethod.apply(this, args);
                }));
            }
            else if (consumes == ContentType_1.ContentType.IMAGE_JPEG) {
                result = bootstrapper_1.App.serverManager.getInstance().delete(finalPath, (0, express_formidable_1.default)(), (req, res, next) => __awaiter(this, void 0, void 0, function* () {
                    yield doDummy(req, res, next);
                    originalMethod.apply(this, args);
                }));
            }
            else {
                result = bootstrapper_1.App.serverManager.getInstance().delete(finalPath, (req, res, next) => __awaiter(this, void 0, void 0, function* () {
                    yield doDummy(req, res, next);
                    originalMethod.apply(this, args);
                }));
            }
